...
Multiple examples can be found in the [SEP-06 test cases](https://github.com/Soneso/stellar-swift-wallet-sdk/blob/main/Tests/stellar-wallet-sdkUnitTests/TransferTest.swift)
